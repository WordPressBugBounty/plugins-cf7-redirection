 ...
 * Domain Path: /lang
 *
 * @package Successful Redirection for Contact Form 7
 * @category Successful Redirection for Contact Form 7
 * @author JAYASREE TU
 */
...
class WPCF7_Redirect {
	...
	public function add_panel( $panels ) {
		$panels['redirect-panel'] = array(
			'title'    => __( 'Contactform7 Redirection Settings', 'wpcf7-redirect' ),
	...
	public function create_panel_inputs( $post ) {
		...
		<h2>
			<?php esc_html_e( 'Contactform7 Redirect Settings', 'wpcf7-redirect' ); ?>
		</h2> <hr />
